...
const tests = {
   ...
   "passing:sync": {
      ...
      "<(0,0)|(0,0)>":   {
         valid: true,
         throws: [
            [[{ value: 0, handFrom: 0, handTo: 0 }], [{ value: 0, handFrom: 1, handTo: 1 }], [{ value: 0, handFrom: 2, handTo: 2 }], [{ value: 0, handFrom: 3, handTo: 3 }]]
         ]
      },
      "<(4,4)|(4,2x)*>": {
         valid:  true,
   ...
   "multihand": {
      ...
      "A0": {
         valid: true,
         throws: [[[{ value: 0, handFrom: 0, handTo: 0 }]]]
      },
      "A5,A1": {
         valid: true,
         throws: [[[{ value: 5, handFrom: 0, handTo: 0 }]], [[{ value: 1, handFrom: 0, handTo: 0 }]]]
      },
      "[A3,A1]": {
         valid: true,
         throws: [[[{ value: 3, handFrom: 0, handTo: 0 }, { value: 1, handFrom: 0, handTo: 0 }]]]
      },
      [`B4,B2,[A3,B3]
        A1,A5,[A3,B3]`]: {
         valid: true,
         throws: [
            [[{ value: 4, handFrom: 0, handTo: 1 }], [{ value: 1, handFrom: 1, handTo: 0 }]],
