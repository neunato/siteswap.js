...
function toString(notation = this.notation) {
   ...
   if (this.notation !== notation) {
      ...
      if (properties.some((prop) => to[prop] !== undefined &&
                                    from[prop] !== undefined &&
         ...
         throw new SiteswapError("Incompatible notations.")
      ...
      if (properties.some((prop) => (to[prop].max && this[prop] > to[prop].max) ||
         ...
         throw new SiteswapError("This siteswap can't be converted to the target notation.")
   }
